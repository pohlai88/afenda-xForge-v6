...
export const metadata: Metadata = {
  title: 'AdminCN - Icon Menu Layout Shadcn Admin Dashboard Template',
  description:
    'Launch powerful admin panels faster with AdminCN Icon Menu Layout Shadcn Admin Dashboard Template, featuring modern UI, responsive layouts, and reusable components.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'AdminCN - Icon Menu Layout Shadcn Admin Dashboard Template'
      }
    ]
  },
  twitter: {
  ...
  return (
    ...
    >
      <body className='flex min-h-full w-full flex-auto flex-col'>
        <NuqsAdapter>
          <Providers settingsCookie={settingsData}>
