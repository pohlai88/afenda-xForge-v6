...
export const metadata: Metadata = {
  title: 'AdminCN - Split Layout Shadcn Admin Dashboard Template',
  description:
    'Launch powerful admin panels faster with AdminCN Split Layout Shadcn Admin Dashboard Template, featuring modern UI, responsive layouts, and reusable components.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'AdminCN - Split Layout Shadcn Admin Dashboard Template'
      }
    ]
  },
  twitter: {
