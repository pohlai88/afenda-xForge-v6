...
export const db: FaqData = {
  ...
  supportCards: [
    ...
    },
    {
      ...
      description:
        'Browse setup guides, API references, release notes, and troubleshooting playbooks to resolve common admin tasks independently, quickly, and with confidence.',
