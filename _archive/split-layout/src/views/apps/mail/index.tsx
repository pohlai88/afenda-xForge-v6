...
const MailApp = () => {
  ...
  return (
    <>
      <div className='flex h-[calc(100dvh-11.25rem)] flex-col sm:h-[calc(100dvh-12rem)] lg:min-h-130'>
        {/* Desktop layout */}
        ...
        {/* Mobile layout */}
        <div className='border-border bg-background flex h-full flex-col overflow-hidden rounded-lg border lg:hidden'>
          {mobileView === 'list' && (
      ...
      <MailCompose
        key={isComposeOpen ? MAIL_COMPOSE_SESSION.OPEN : MAIL_COMPOSE_SESSION.CLOSED}
        open={isComposeOpen}
