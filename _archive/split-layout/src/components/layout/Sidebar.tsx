...
const SidebarLayout = () => {
  ...
  return (
    <Sidebar
      ...
      variant='floating'
      className='p-6 pr-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1.01)]! *:data-[slot=sidebar-inner]:group-data-[variant=floating]:rounded-xl'
    >
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
