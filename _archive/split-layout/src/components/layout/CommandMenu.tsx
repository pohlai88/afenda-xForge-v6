...
const CommandMenu = () => {
  ...
  return (
    <>
      <Button
        variant='default'
        className='bg-secondary/20 text-muted hover:bg-secondary/20 hidden w-full max-w-72 px-2.5 font-normal md:block'
      ...
      <Button variant='ghost' size='icon' className='max-md:ml-auto md:hidden' onClick={() => setOpen(true)}>
        <SearchIcon />
