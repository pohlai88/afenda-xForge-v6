  ...
  return (
    <>
      <Button
        variant='outline'
        className={cn(
          'hidden px-2.5 font-normal hover:bg-transparent sm:block md:w-xs dark:hover:bg-transparent',
          className
        )}
        onClick={() => setOpen(true)}
      >
        <div className='text-muted-foreground hidden items-center justify-between gap-1.5 text-sm sm:flex'>
