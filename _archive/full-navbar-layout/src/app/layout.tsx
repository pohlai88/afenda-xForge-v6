...
export const metadata: Metadata = {
  title: 'AdminCN - Full Navbar Layout Shadcn Admin Dashboard Template',
  description:
    'Launch powerful admin panels faster with AdminCN Full Navbar Layout Shadcn Admin Dashboard Template, featuring modern UI, responsive layouts, and reusable components.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'AdminCN - Full Navbar Layout Shadcn Admin Dashboard Template'
      }
    ]
  },
  twitter: {
