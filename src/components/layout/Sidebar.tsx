            ...
            return item.childItems ? (
                      ...
                      {item.childItems.map(subItem =>
                        isSubGroup(subItem) ? (
                          ...
                          <SidebarMenuSubItem key={subItem.label}>
                            <SidebarMenuSubButton
                              className='data-active:bg-primary/10! hover:bg-primary/5 justify-between'
              ...
              <SidebarMenuItem key={item.label}>
                <SidebarMenuButton
                  ...
                  className='data-active:bg-primary/10! hover:bg-primary/5'
                >
                  {Tag && <Tag />}
                  <span>{item.label}</span>
...
const SidebarLayout = () => {
  ...
  return (
    <Sidebar
      ...
      className='**:data-[slot=sidebar-inner]:bg-muted border-r-0!'
    >
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
