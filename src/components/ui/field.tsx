...
const fieldVariants = cva('group/field data-[invalid=true]:text-destructive-strong flex w-full gap-3', {
  variants: {
    orientation: {
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn('text-destructive-strong text-sm font-normal', className)}
      {...props}
    >
      {content}
    </div>
