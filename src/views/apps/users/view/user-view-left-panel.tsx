...
export function UserViewLeftPanel({ user, onEdit, onToggleSuspend }: UserViewLeftPanelProps) {
  ...
  return (
    <Card className='overflow-y-auto lg:sticky lg:top-19 lg:h-[calc(100dvh-7.5rem)]'>
